...
<body>
  ...
  <div class="menu">
    <ul class="nav justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="link.php">Collaboration</a>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="link.php">Outerwear</a>
          <a class="dropdown-item" href="link.php">Tunic</a>
          <a class="dropdown-item" href="link.php">Blouse</a>
          <a class="dropdown-item" href="link.php">Bottom</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="link.php">Basic</a>
          <a class="dropdown-item" href="link.php">Pattern</a>
          <a class="dropdown-item" href="link.php">Pashmina</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="link.php">Sleepwear</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="link.php" style="color: red;">SALE</a>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="link.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          Accessories
        </a>
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="link.php">Pin</a>
          <a class="dropdown-item" href="link.php">Scraf</a>
          <a class="dropdown-item" href="link.php">Brooch</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="link.php">Payment Confirmation</a>
      </li>
    </ul>
  </div>
        ...
        <?php foreach ($barang as $isi) : ?>
          <div class="col-3">
            ...
            <div class="card" style="width: 100%;">
              <img src="img/<?= $isi['gambar_barang'] ?>" width="100" class="card-img-top" alt="...">
              <div class="card-body">
                <p class="card-text">
                  <a href="bestproduk.php"><?= $isi['nama_barang'] ?><br><?= $isi['harga_barang'] ?></a>
                </p>
              </div>
    ...
    <div class="row">
      <div class="col-3">
        <p class="link">
          About Us
          <br>
          <a href="link.php">Fashionable's History</a>
        </p>
      </div>
      <div class="col-3">
        <p class="link">
          Contact
          <br>
          <a href="link.php">Contact Us</a><br>
          <a href="link.php">Store Location</a><br>
          <a href="link.php">Career</a>
        </p>
      </div>
      <div class="col-3">
        <p class="link">
          Help
          <br>
          <a href="link.php">FAQ</a>
          <a href="link.php">Payment & Delivery</a><br>
          <a href="link.php">Return & Refund</a>
        </p>
      </div>
      <!-- Sosial Media -->
      <div class="row">
